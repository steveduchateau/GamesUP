...
public class OrderControllerTest {
    ...
    public void setUp() {
        ...
        // Initialisation de l'objet Client avec les informations de base
        client = new Client(1L, "Nom Client", "client@example.com");

        // Initialisation de l'objet Order avec les paramètres adéquats
    ...
    public void testGetAllOrdersAsAdmin() throws Exception {
        ...
        mockMvc.perform(get("/api/orders"))
                ...
                // Suppression des assertions sur les champs potentiellement non initialisés
    ...
    public void testAddOrder() throws Exception {
        when(orderService.addOrder(any(Order.class))).thenAnswer(invocation -> {
            ...
            createdOrder.setStatus("Pending");  // Mise à jour du statut
            return createdOrder;
        });
